...
!!      ebands_update_occ,ebands_write,eph_gkk,eph_phgamma,eph_phpi,hdr_free
...
!!      ncwrite_v1qnu,pawfgr_destroy,pawfgr_init,phdos_free,phdos_ncwrite
!!      phdos_print,phdos_print_thermo,print_ngfft,pspini,sigmaph
!!      wfk_read_eigenvalues,wrtout,xmpi_bcast,xmpi_end
!!
!! SOURCE
