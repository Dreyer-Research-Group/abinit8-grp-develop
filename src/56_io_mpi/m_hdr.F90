...
!!      inpgkk,inwffil,ioprof,linear_optics_paw,m_bader,m_bse_io,m_cut3d,m_ddk
...
!!
!! PARENTS
!!      cut3d,ioprof,m_bader,m_ddk,m_dvdb,m_hdr,m_wfd,m_wfk,mrggkk,rchkgsheader
!!
!! CHILDREN
!!
!! SOURCE
...
!!
!! PARENTS
!!      elphon,m_bader,m_dvdb,m_hdr,m_io_screening,m_ioarr,m_wfk,optic,read_gkk
!!
!! CHILDREN
!!
!! SOURCE
...
!!
!! PARENTS
!!      elphon,inpgkk,m_bader,m_bse_io,m_cut3d,m_dvdb,m_hdr,m_io_screening
...
!!
!! PARENTS
!!      inwffil,m_bader,m_ddk,m_dvdb,m_hdr,m_io_screening,m_ioarr,macroave
!!
!! CHILDREN
!!
!! SOURCE
