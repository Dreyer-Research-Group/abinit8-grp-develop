...
!!
!! PARENTS
!!      cchi0q0_intraband,conducti_nc,dfpt_looppert,gstate,m_ebands,m_occ
!!
!! CHILDREN
...
!CEDrev: TEST
!     write(*,'(a10,2i3,a6,2e12.4e2,a6,2e12.4e2,a12,1e12.4e2)') "bands:", ibandkq,ibandk,&
!          & "eigs",eig0_kq(ibandkq),eig0_k(ibandk),"occs",occ_kq(ibandkq),occ_k(ibandk),&
!          & "rocceig", rocceig(ibandkq,ibandk)
