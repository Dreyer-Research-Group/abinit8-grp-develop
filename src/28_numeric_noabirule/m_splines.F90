...
!! PARENTS
!!      m_occ,m_pawpwij,mkffnl,pawgylmg,psp8lo
!!
!! CHILDREN
!!
!! SOURCE
...
!!      m_atom,m_bader,m_dens,m_entropyDMFT,m_ewald,m_occ,m_paw_slater
!!      m_special_funcs,m_splines,outscfcv,pawinit,predict_string,psp10in
!!      psp10nl,psp11nl,psp1cc,psp1in,psp2in,psp3in,psp4cc,psp5in,psp5nl,psp6in
!!      psp8in,psp8lo,psp8nl,psp9in,random_stopping_power,spline_paw_fncs
!!      upf2abinit,vso_realspace_local
!!
!! CHILDREN
!!
!! SOURCE
...
!!      outscfcv,partial_dos_fractions,predict_string,psp6in
