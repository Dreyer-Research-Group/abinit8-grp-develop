...
!!
!! PARENTS
!!      psp11lo,psp11nl,psp5lo,psp5nl,psp6in,psp8lo,psp8nl
!!
!! CHILDREN
!!      simpson_int,wrtout
!!
...
!!
!! PARENTS
!!      calc_rpa_functional,calc_sigc_me,m_bader,m_numeric_tools,screening
!!
!! CHILDREN
!!      simpson_int,wrtout
!!
...
!!
!! PARENTS
!!      eliashberg_1d,evdw_wannier,m_ebands,m_exc_spectra,m_numeric_tools
!!      m_phgamma,m_phonons,m_xc_vdw,mka2f,mka2fQgrid,mka2f_tr,mka2f_tr_lova
!!      mlwfovlp_projpaw,mlwfovlp_radial,outscfcv,radsintr
!!
!! CHILDREN
!!      simpson_int,wrtout
!!
