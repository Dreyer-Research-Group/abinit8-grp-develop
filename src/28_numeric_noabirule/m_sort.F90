...
!!
!! PARENTS
!!      atomden,denfgr,finddistrproc,invacuum,listkk,m_bader,m_bz_mesh,m_chi0
!!      m_cut3d,m_exc_diago,m_geometry,m_gsphere,m_ifc,m_io_screening
!!      m_paw_pwaves_lmn,m_phonons,m_polynomial_coeff,m_screen,m_skw,m_tddft
!!      m_use_ga,m_vcoul,mkcore,mkcore_inner,mkcore_wvl,mlwfovlp_qp,outscfcv
!!      partial_dos_fractions,symkpt,thmeig,wvl_initro
!!
!! CHILDREN
!!
!! SOURCE
...
!!
!! PARENTS
!!      getng,getngrec,initmpi_img,invars2,irrzg,m_dvdb,m_geometry,m_hdr
!!      m_nesting,m_wfk,mkfskgrid
!!
!! CHILDREN
!!
!! SOURCE
