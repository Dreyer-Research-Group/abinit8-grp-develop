...
interface
 subroutine dotprod_set_cgcprj(atindx1,cg1,cg2,cprj1,cprj2,dimcprj,hermitian,&  
  ...
  use m_pawtab
  implicit none
  integer, intent(in) :: hermitian
  integer, intent(in) :: ibg1
  integer, intent(in) :: ibg2
  ...
  integer, intent(in) :: mcprj1
  integer, intent(in) :: mcprj2
  integer, intent(in) :: mkmem
  integer, intent(in) :: natom
  ...
  real(dp), intent(in) :: cg2(2,mcg2)
  type(pawcprj_type),intent(in) :: cprj1(natom,mcprj1)
  type(pawcprj_type),intent(in) :: cprj2(natom,mcprj2)
  integer, intent(in) :: dimcprj(natom)
  integer, intent(in) :: nattyp(ntypat)
  type(pawtab_type),intent(in) :: pawtab(ntypat*usepaw)
...
interface
 subroutine dotprodm_sumdiag_cgcprj(atindx1,cg_set,cprj_set,dimcprj,&  
  ...
  integer, intent(in) :: npw
  integer, intent(in) :: nset1
  integer, intent(in) :: nset2
  integer, intent(in) :: nspinor
  integer, intent(in) :: nsppol
  integer, intent(in) :: ntypat
  integer, intent(in) :: shift_set1
  integer, intent(in) :: shift_set2
  integer, intent(in) :: usepaw
  type(mpi_type),intent(in) :: mpi_enreg
  integer, intent(in) :: atindx1(natom)
