...
!CEDrev: Also exclude finite q J

!TEST
!write(*,*) "userib",dtset%userib
! if (ipert<=natom) then
 if (ipert<=natom .and. dtset%userib==0) then
   ider=0;idir0=0
...
!Compute nonlocal form factors ffnl1 at (k+q+G)
 ...
 ! CEDrev: Again, hack this for finite q J
 else if (ipert==natom+10.or.ipert==natom+11.or.dtset%userib==2) then
   ider=2;idir0=4
