...
!!
!! PARENTS
!!      berryphase,conducti_nc,ddb_hybrid,dfpt_mkvxc,dfpt_mkvxcstr,dfpt_symph
!!      electrooptic,ep_el_weights,ep_fs_weights,ep_ph_weights,fock_getghc
!!      get_kpt_fullbz,getkgrid,getspinrot,gstate,harmonic_thermo,invars2
!!      inwffil,m_cut3d,m_ddb,m_ddk,m_double_grid,m_dynmat
!!      m_effective_potential,m_esymm,m_ewald,m_fock,m_fstab,m_geometry,m_ifc
!!      m_outwant,m_pimd,m_psps,m_strain,m_supercell,m_tddft,m_tdep_latt
!!      make_efg_el,make_efg_ion,mover,optic,pimd_langevin_npt,prtxf,relaxpol
!!      respfn,smpbz,stresssym,symbrav,symlatt,symmetrize_rprimd,symrelrot
!!      symrhg,testkgrid,thmeig,uderiv,xfpack_x2vin
!!
!! CHILDREN
!!
!! SOURCE
