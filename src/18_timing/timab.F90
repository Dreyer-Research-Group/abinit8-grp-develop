...
!!      m_lobpcg,m_lobpcg2,m_lobpcgwf,m_occ,m_paral_pert,m_sg2002,m_suscep_stat
!!      m_tddft,m_wfutils,m_xg,m_xgScalapack,mag_constr,mkcore,mkcore_paw
!!      mkcore_wvl,mkffnl,mklocl_realspace,mklocl_recipspace,mkresi,mkrho
!!      newkpt,newrho,newvtr,nhatgrid,nlenergyrec,nonlinear,nonlop,odamix
!!      opernla_ylm,optics_paw,optics_paw_core,optics_vloc,outkss,outscfcv
...
!!      symrhg,symsgcube,timana,vn_nl_rec,vtorho,vtorhorec,vtorhotf,vtowfk
!!      wf_mixing,wfconv,wfk_analyze,wfsinp,wvl_nhatgrid,xcden,xcpot
!!
!! CHILDREN
