...
!!      m_sigmaph,m_slk,m_tddft,m_wfd,m_wffile,m_wfk,mlwfovlp,mlwfovlp_pw,mover
!!      mover_effpot,outkss,pawmkaewf,qmc_prep_ctqmc,rf2_init,sigma,vtorho
!!      vtorhorec,wfk_analyze
!!
!! CHILDREN
!!      mpi_type_commit,mpi_type_size,xmpi_abort,xmpio_type_struct
!!
