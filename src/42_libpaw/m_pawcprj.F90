...
!!      m_plowannier,m_shirley,m_suscep_stat,m_wfd,make_grad_berry,nonlop
...
!!      setup_positron,sigma,smatrix_pawinit,update_e_field_vars,vtorho,vtowfk
...
!!      m_phgamma,m_phpi,m_plowannier,m_scf_history,m_shirley,m_sigmaph
!!      m_suscep_stat,m_wfd,make_grad_berry,nonlop,optics_paw,optics_paw_core
...
!!      smatrix_pawinit,update_e_field_vars,vtorho,vtowfk,wf_mixing
...
!!      fock2ACE,forstrnps,m_plowannier,m_suscep_stat,make_grad_berry
!!      optics_paw,optics_paw_core,pawmkrhoij,posdoppler,rf2_init
...
!!
!! PARENTS
!!      berryphase_new,cgwf,m_suscep_stat,optics_paw,optics_paw_core
!!
!! CHILDREN
!!      xmpi_sum
!!
